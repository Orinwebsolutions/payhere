...
$paymentOpts = templatic_get_payment_options('payhere');
...
//echo '---<br/>';
//echo $returnUrl.'&pid='.$last_postid;
//echo '---<br/>';
//echo $cancel_return;
//echo '---<br/>';
//echo $notify_url;
...
//$city = '';
//$address = '';
//$returnUrl = 'http://www.srilankatourismcatalog.com/';
//echo $returnUrl;
//die();
...
<!--<input type="hidden" name="return_url" value="<?php// echo $returnUrl;?>&pid=<?php //echo $last_postid;?>&trans_id=<?php //echo $trans_id; ?>"/>
<input type="hidden" name="cancel_url" value="<?php// echo $cancel_return;?>&pid=<?php //echo $last_postid;?>&trans_id=<?php //echo $trans_id; ?>"/>-->
